...
const [orderBy, setOrderBy] = useState('date'); // Default sort by Date & Time
// Sorting functions
...
const descendingComparator = (a, b, orderBy) => {
  ...
  if (orderBy === 'date' || orderBy === 'originalDate') {
  ...
  <TableRow>
    {[
      ...
      { id: 'empId', label: 'Employee Name', sortable: true },
      { id: 'department', label: 'Department', sortable: true },
      { id: 'branch', label: 'Branch', sortable: true },
      { id: 'action', label: 'Action', sortable: true },
      { id: 'systemIP', label: 'System IP', sortable: true },
